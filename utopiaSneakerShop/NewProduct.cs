...
namespace utopiaSneakerShop
{
    public partial class NewProduct : Form
    {
        ...
        private void NewButton_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("INSERT INTO products(productColor, productPrice, productStyleCode, productCondition, productModel_productModelID) " +
                                                "VALUES (@color, @price, @stylecode, @condition, @modelID)", con);
            ...
            try
            {
                ...
                ErrorLabel.Text = "New product created with success!";
                ErrorLabel.Visible = true;
                con.Close();
            }
            catch (Exception e1)
